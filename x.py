        ...
        if (not self.selected) and self.piece_at(event) != None:
            ...
            if event == self.position:
                ...
                if board.is_legal(move):
                    ...
                    print("Hash:", present_hash, bot.get_hash(board))
                    print(move)
...
class Bot:
    ...
    def max(self, board, depth, beta):
        ...
        hhhh = self.get_hash(board)
        if (hhhh != present_hash):
            print("ngu")
            print(hhhh, present_hash)
    ...
    def min(self, board, depth, anpha):
        ...
        hhhh = self.get_hash(board)
        if (hhhh != present_hash):
            print("ngu", present_score, bot.evaluated(board))
            print(hhhh, present_hash, depth)
            print(board)
        v = self.d.get(present_hash)
        if v != None:
            zob = zob + 1
